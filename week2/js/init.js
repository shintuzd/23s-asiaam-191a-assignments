const map2 = L.map('the_map2').setView([34.058032, -118.245242], 13); // (1)!
...
function addMarker2(lat,lng, icon_color, title,message){
    console.log(message)
    L.marker([lat,lng], {icon: icon_color}).addTo(map2).bindPopup(`<h2>${title}</h2> <h3>${message}</h3>`)
    return message
}
